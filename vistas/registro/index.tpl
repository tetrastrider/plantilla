...
<select name="bd" class="verbasededatos">
</select>
...
<aside>
  ...
  <div class="envase mod">
   <center><p><i class="fa fa-hdd-o" aria-hidden="true"></i>&nbsp; Espacio libre  </espaciol/></p></center>
  </div>
<!-------->
<!----hdd---->
  <div class="envase mod">
   <center><p><i class="fa fa-hdd-o" aria-hidden="true"></i>&nbsp; Espacio total  </espaciot/></p></center>
  </div>
<!-------->
 <!----fecha---->
  <div class="envase mod">
   <center><p><i class="fa fa-clock-o" aria-hidden="true"></i>&nbsp; Fecha </fecha/></p></center>
  </div>
<!-------->
<!----fecha---->
  <div class="envase mod">
   <center><p><i class="fa fa-paper-plane-o" aria-hidden="true"></i>&nbsp; Arriba <span class='serverup'></span></p></center>
  </div>
<!-------->
<!----fecha---->
  <div class="envase mod">
   <center><p><i class="fa fa-tachometer" aria-hidden="true"></i>&nbsp; Carga del servidor <span class='carga'></span></p></center>
  </div>
<!-------->
</aside>
</div>
